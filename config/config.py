...
class Config:
    ...
    # Core Trading Parameters - AGGRESSIVE MODE
    MIN_PROFIT_PERCENTAGE: float = 0.6    # 0.6% detection threshold (aggressive)
    MIN_PROFIT_THRESHOLD: float = 0.6     # 0.6% minimum for execution
